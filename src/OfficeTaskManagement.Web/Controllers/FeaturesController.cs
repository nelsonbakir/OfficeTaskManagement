...
namespace OfficeTaskManagement.Controllers
{
    ...
    public class FeaturesController : Controller
    {
        ...
        // GET: Features
        public async Task<IActionResult> Index(int? projectId, int? epicId, [FromServices] OfficeTaskManagement.Services.Authorization.IPermissionService permSvc)
        {
            ...
            {
                query = query.Where(f => f.Epic.ProjectId == projectId.Value);
            }
            if (epicId.HasValue)
            {
