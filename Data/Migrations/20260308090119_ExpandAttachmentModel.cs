...
{
    /// <inheritdoc />
    public partial class ExpandAttachmentModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestCaseId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_Epics_EpicId",
                        column: x => x.EpicId,
                        principalTable: "Epics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachments_Features_FeatureId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachments_UserStories_UserStoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_EpicId",
                table: "Attachments",
                column: "EpicId");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_FeatureId",
                table: "Attachments",
                column: "FeatureId");
